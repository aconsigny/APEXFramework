/* Formatted on 19/12/2013 11:21:53 AM (QP5 v5.185.11230.41888) */
set define off;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_01_mesg_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_struc_admin_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_25_versn_publc_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_struc_aplic_lang_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_25_publc_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_struc_aplic_destn_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_01_ocurn_sa_en_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_histr_acces_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_23_reslt_rechr_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_group_stat_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_gr_ut_opert_opt_d_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_fonct_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_23_rechr_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_fonct_struc_aplic_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_23_patrn_rechr_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting then
    if :new.seqnc is null then
      select   sie_01_mesg_infor_seq.nextval
        into   :new.seqnc
        from   dual;
    end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_01_evenm_notfb_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_30_efort_item_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_30_histr_efort_restn_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_30_item_carnt_prodt_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_30_item_carnt_sprin_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_30_page_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_07_insta_semph_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
prompt Trigger VD_SIE_13_PAGE_IR_COLN_IOU_TRG;

create or replace trigger vd_sie_13_page_ir_coln_iou_trg
  instead of update
  on vd_sie_13_page_ir_coln
  for each row
declare
  vnu_ref_mesg_aide                       number (10);
begin
  if :new.ref_mesg_aide_numr is not null then
    select   m.seqnc
...
exception
  when others then
    raise;
end vd_sie_13_page_ir_coln_iou_trg;
/
...
begin
  if inserting and :new.seqnc is null then
    select   sie_20_sectn_docmn_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_arbre_noeud_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_ocurn_resrc_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_navgt_elemn_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_navgt_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_20_modl_excep_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_20_modl_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_menu_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_04_fil_arian_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_page_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_domn_fonct_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_21_plugn_menu_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_page_ir_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_opert_optio_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_opert_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_prefr_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_regn_piltb_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_page_prefr_navgt_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_21_plugn_calnd_type_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_page_lang_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_page_item_lang_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_21_plugn_item_menu_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_page_item_seq.nextval
      into   :new.seqnc
      from   dual;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_atrib_struc_aplic_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_defnt_acces_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_23_d_aplic_modl_rechr_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_struc_aplic_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_arbre_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
create or replace trigger sie_13_expor_page_bi_trg
  ...
  for each row
begin
  select   sie_13_expor_page_seq.nextval
    into   :new.seqnc
    from   dual;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_14_detl_domn_valr_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
create or replace trigger sie_13_expor_aplic_bi_trg
  ...
  for each row
begin
  select   sie_13_expor_aplic_seq.nextval
    into   :new.seqnc
    from   dual;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_04_navgt_histr_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting then
    select   sie_03_trace_exect_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_dosr_virtl_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_07_semph_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_17_compt_twili_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_17_fil_atent_destn_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_17_fil_atent_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_mime_type_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_17_compt_axiat_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_17_atach_courl_entra_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_condt_exect_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_empla_dosr_virtl_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_condt_piltb_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_page_ir_coln_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_19_boutn_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_19_dispn_fonct_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_19_fonct_lang_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_17_sms_twili_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_17_telcp_axiat_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_17_sms_twili_entra_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_17_propr_courl_entra_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_17_profl_courl_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_20_modl_parmt_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_19_specf_fonct_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_17_piece_telcp_axiat_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_17_courl_entra_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_20_docmn_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_liste_navgt_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_20_detl_docmn_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_lien_condt_piltb_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_21_plugn_calnd_coulr_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_item_menu_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_insta_prefr_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_20_deplm_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_formt_resrc_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_21_plugn_arbre_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_21_plugn_arbre_noeud_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_25_engin_versn_publc_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_actio_audit_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_type_fichr_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_resrc_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_21_plugn_calnd_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_13_regn_piltb_lang_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_25_valr_champ_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_favr_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_evolt_stat_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_domn_utils_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_domn_servr_ldap_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_23_enonc_rechr_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_domn_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_23_detl_reslt_rechr_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_25_group_publc_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_stat_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_servr_ldap_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_reqt_inter_utils_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_25_engin_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_29_contr_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_membr_struc_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_lien_struc_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_lien_group_utils_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_25_elemn_confg_publc_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_30_cas_utils_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_01_atrib_modl_comnc_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_01_code_err_oracl_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_30_page_item_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_01_destn_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_01_destn_confg_en_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_01_elemn_confg_en_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_01_hierc_aplic_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_01_lang_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_01_lang_lang_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_01_mesg_err_lie_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_01_mesg_lang_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_01_mesg_tradc_apex_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_01_modl_afich_notfc_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_01_modl_comnc_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_01_modl_mesg_notfc_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_01_notfc_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_30_afect_item_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_30_carnt_prodt_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_01_reslt_destn_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_03_journ_struc_aplic_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_01_type_comnc_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_30_carnt_systm_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_30_carnt_sprin_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_03_clas_inter_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_03_lien_clas_inter_uti_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_25_champ_publc_travl_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_04_contx_etend_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_25_champ_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_25_domn_type_publc_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_07_audit_struc_aplic_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_25_journ_travl_exect_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_07_sesn_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_07_valr_audit_sa_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_11_aplic_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_25_ocurn_parmt_pub_tra_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_11_atrib_entit_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_11_entit_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_25_parmt_publc_travl_e_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_11_parmt_afw_seqnc.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_11_plugn_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_11_prodt_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_25_parmt_publc_travl_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_11_prodt_lang_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_11_prodt_resrc_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_25_parmt_type_publc_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_11_utils_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_11_versn_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_25_publc_travl_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_25_travl_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_25_type_publc_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_25_type_travl_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_utils_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_25_valr_elemn_confg_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
...
begin
  if inserting and :new.seqnc is null then
    select   sie_12_type_struc_seq.nextval
      into   :new.seqnc
      from   dual;
  end if;
